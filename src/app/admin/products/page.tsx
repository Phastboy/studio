...
import { PlusCircle, Edit3, Trash2, Package, AlertTriangle, Loader2 } from 'lucide-react';
  ...
  if (isLoadingProducts) {
    return (
      <div className="flex justify-center items-center min-h-[calc(100vh-theme(spacing.16))]">
        ...
        <p className="ml-4 text-lg text-muted-foreground">Loading inventory...</p>
      </div>
    );
  }
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <ProductForm
            ...
            // isLoading={isSubmittingProduct} // Add loading state if needed
          />
        </DialogContent>
      </Dialog>
